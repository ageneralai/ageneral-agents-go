...
- **Import path changes are mechanical**. After merging `pkg/core/*`, find-and-replace `coreevents "github.com/ageneralai/ageneral-agents-go/pkg/core/events"` with `"github.com/ageneralai/ageneral-agents-go/pkg/hooks"` across all files.
