...
//go:linkname patchedNewMCPClient github.com/ageneralai/ageneral-agents-go/pkg/tool.newMCPClient
...
//go:linkname patchedNewMCPClientWithOptions github.com/ageneralai/ageneral-agents-go/pkg/tool.newMCPClientWithOptions
